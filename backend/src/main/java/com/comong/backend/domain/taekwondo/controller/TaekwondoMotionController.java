...
public class TaekwondoMotionController {
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "400",
                description = "poomsae enum 값이 유효하지 않음 (G-001)")
    })
    @GetMapping
    public ResponseEntity<ApiResponse<List<TaekwondoMotionResponse>>> list(
            @Parameter(description = "품새 (enum)", required = true) @RequestParam Poomsae poomsae) {
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "404",
                description = "태권도 동작 없음 (TK-001)")
    })
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<TaekwondoMotionResponse>> detail(
            @Parameter(description = "태권도 동작 ID", required = true) @PathVariable Long id) {
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "409",
                description =
                        "같은 품새에 이미 등록된 routineOrder (TK-002) 또는 동작 이름 중복 (TK-007). body.code 로 구분"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "413",
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "400",
                description = "입력값 검증 실패 (G-001) 또는 보낸 동작 목록이 현재 목록과 일치하지 않음 (TK-008)"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "401",
                description = "인증 필요 (G-003)"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "409",
                description = "routineOrder 중복 (TK-002) 또는 동작 이름 중복 (TK-007). body.code 로 구분"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "413",
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
                responseCode = "409",
                description = "수행 기록에서 사용 중 (TK-003)")
    })
    @PreAuthorize("hasRole('ADMIN')")
    @DeleteMapping("/{id}")
