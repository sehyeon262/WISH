...
class DanielUpwardPressFeatureSet:
    wrist_height: float | None
    wrist_height_balance: float | None
...
def extract_daniel_upward_press_features(
    ...
    wrist_height_balance = _compute_wrist_height_balance(left_wrist=left_wrist, right_wrist=right_wrist)
    ...
    return DanielUpwardPressFeatureSet(
        wrist_height=wrist_height,
        wrist_height_balance=wrist_height_balance,
...
def _compute_wrist_height_balance(
    *,
    left_wrist: NormalizedLandmark | None,
    right_wrist: NormalizedLandmark | None,
) -> float | None:
